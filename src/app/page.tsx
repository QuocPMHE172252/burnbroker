...
const FLOW_STEPS = [
  { num: "01", title: "Encrypt", desc: "Client-side AES-256 encryption before credentials leave your browser" },
  { num: "02", title: "Isolate", desc: "Decrypted only inside a hardware-isolated TEE enclave" },
  { num: "03", title: "Execute", desc: "Single API call to Binance with HMAC-signed request" },
  { num: "04", title: "Destroy", desc: "RAM overwritten with 0x00, key permanently erased" },
  { num: "05", title: "Attest", desc: "Hardware-signed proof that destruction occurred" },
];
...
export default function Home() {
  ...
  return (
    <main className="min-h-screen bg-[#09090b] text-gray-200 font-sans selection:bg-purple-500/30 flex flex-col">
      {/* ── Navbar ── */}
      <nav className="border-b border-white/[0.06] bg-[#09090b]/80 backdrop-blur-xl sticky top-0 z-50">
        ...
        {/* Row 2: Tab bar */}
        <div className="px-5 md:px-8 flex gap-0 overflow-x-auto">
          {TABS.map((t) => (
            <button
              key={t.id}
              onClick={() => setTab(t.id)}
          ...
          {tab === "about" && (
            ...
            >
              ...
              <div className="max-w-2xl mx-auto">
                <div className="bg-[#0f0f13] border border-white/[0.06] rounded-xl p-6 space-y-4">
                  <h3 className="text-sm font-semibold text-white">Research & Resources</h3>
                  <div className="grid sm:grid-cols-2 gap-3">
                    <a
                      href="https://arxiv.org/abs/2510.21904"
                      target="_blank"
                      rel="noopener noreferrer"
                      className="flex items-center gap-3 bg-black/30 border border-white/[0.06] rounded-lg p-4 hover:border-purple-500/30 transition-colors group"
                    >
                      ...
                      <div className="min-w-0">
                        ...
                        <div className="text-[11px] text-gray-600 truncate">
                          arXiv:2510.21904 — Game-theoretic TEE framework
                        </div>
                      </div>
                    ...
                    >
                      ...
                      <div className="min-w-0">
                        ...
                        <div className="text-[11px] text-gray-600 truncate">
                          GitHub — QuocPMHE172252/burnbroker
                        </div>
                      </div>
                      <ExternalLink className="w-3.5 h-3.5 text-gray-700 flex-shrink-0" />
                    </a>
                  ...
                  <div className="pt-3 border-t border-white/[0.04]">
                    <div className="flex flex-wrap gap-2">
                      {["Next.js", "Binance API", "AES-256-CBC", "HMAC SHA256", "Polygon Amoy", "RainbowKit"].map((t) => (
                        <span
                          key={t}
                          className="text-[10px] bg-white/[0.04] border border-white/[0.06] text-gray-500 px-2 py-0.5 rounded-md font-medium"
                        >
                          {t}
                        </span>
                      ))}
                ...
                <div className="text-center mt-8 text-[11px] text-gray-700">
